...
import { Col, message, Row, Form, Tooltip, Input, Select, Button } from "antd";
...
const DatabaseEdit = ({ setLoading }: any) => {
  ...
  return (
    <Form form={form} onFinish={onFinish} layout="vertical" name="editDatabase">
      <div className="mt-3">
        <Row>
